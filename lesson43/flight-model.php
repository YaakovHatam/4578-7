<?php  
    ...
    class FlightModel implements IModel, JsonSerializable {
        ...
        public function jsonSerialize() {
            return [
                ...
                'flight_from' =>  $this->getFlightFrom(),
                'flight_to' => $this->getFlightTo(),
                'flight_datetime' =>  $this->getFlightDateTime(),
                'flight_special_comments' =>  $this->getFlightSpecialComments(),
                'pilot_id' =>  $this->getPilotModel()->getPilotId()
            ];
        }
    }
